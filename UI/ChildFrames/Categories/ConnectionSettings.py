...
class ConnectionSettings(tk.LabelFrame):
    ...
    def __init__(self, root: tk.Widget, dataManager: FileDataManager):
        ...
        self.checkButton_switchToIPv6 = CheckButton(self, 'Switch to IPv6', False)
        ...
        self.checkButton_switchToIPv6.connect(self.dataManager.get('main'), 'checkButton_switchToIPv6')

        self.checkButton_switchToIPv6.pack(anchor=tk.W)
